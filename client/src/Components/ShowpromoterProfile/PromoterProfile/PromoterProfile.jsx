...
import Ellipse from "./../../Profile/Profile/Ellipse.svg";
import pencil from "./../../Profile/Profile/pencil.svg";
import log from "./../../Profile/Profile/log.svg";
  ...
  return (
    <div className="px-4 sm:px-5 font-general">
      ...
      <div className="bg-white mt-4  rounded-lg border-4 w-full max-w-md mx-auto h-auto sm:h-[480px]">
        <Link className="no-underline text-black" to="/PromoterViewProfile">
        ...
        <Link className="no-underline text-black" to="/PromoChangePass">
          <div className="flex items-center justify-between p-5 sm:p-6 border-b">
            <div className="flex items-center">
        ...
        <Link className="no-underline text-black" to="/PromoterActivities">
          <div className="flex items-center justify-between p-5 sm:p-6 border-b">
            <div className="flex items-center">
        ...
        <Link className="no-underline text-black" to="/PromotePremium">
          <div className="flex items-center justify-between p-5 sm:p-6 border-b">
            <div className="flex items-center">
              <FaQuestionCircle className="text-gray-600 mr-3" />
              <p className="text-base sm:text-lg">Get Premium</p>
            </div>
            <FaChevronRight className="text-gray-400" />
          </div>
        </Link>
        ...
        <Link className="no-underline text-black" to="/PromoterHelp">
          <div className="flex items-center justify-between p-5 sm:p-6 border-b">
            <div className="flex items-center">
              <FaQuestionCircle className="text-gray-600 mr-3" />
        ...
        <Link className="no-underline text-black" to="/PromoterSettings">
          <div className="flex items-center justify-between p-5 sm:p-6 border-b">
            <div className="flex items-center">
