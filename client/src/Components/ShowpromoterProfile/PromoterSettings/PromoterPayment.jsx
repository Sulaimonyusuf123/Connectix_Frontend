...
import back from '../../Profile/Settings/back.svg'
import bar from "../../Profile/BuyCoin/bar.svg";

const PromoterPayment = () => {
  return (
    <div className="font-general px-5">
       <div className="flex items-center justify-between w-full">
  <Link to={"/PromoterSettings"}>
    <button className="">
...
export default PromoterPayment ;
